				...
				<div class="card card-primary card-outline">
					...
					<div class="card-header">
						...
						<div class="float-right">
							<a class="btn btn-warning" href="<?=base_url('stok/out');?>"><i class="fa fa-undo"></i> Kembali</a>
						</div>
					</div>
					<div class="col-md-6 offset-md-2">
						<form class="form-horizontal" action="<?=base_url('stok/proses');?>" method="post">
							<div class="card-body">
								...
								<div class="form-group row">
									<label for="detail" class="col-sm-4 col-form-label">Info</label>
									<div class="col-sm-8">
								...
								<div class="card-footer float-right">
									<button type="submit" name="stok_keluar" class="btn btn-primary">Simpan</button>
