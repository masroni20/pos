				...
				<div class="card card-primary card-outline">
					<div class="card-header">
						...
						<div class="float-right">
							<a href="<?=base_url('stok/out/tambah');?>" class="btn btn-primary"><i class="fa fa-plus"></i> Tambah</a>
						</div>
					</div>
					<div class="card-body">
							...
							<tbody>
								...
								<tr>
									...
									<td>
										...
										<a class="btn btn-danger btn-sm" onclick="return confirm('Anda yakin ingin menghapus data ini?')" href="<?=base_url('stok/out/delete/');?><?=$data->id_stok;?>/<?=$data->id_item;?>"><i class="fa fa-trash"></i></a>
									</td>
								</tr>
							<?php endforeach;?>
