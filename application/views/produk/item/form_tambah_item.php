			...
			<div class="col-md-12">
				<div class="card card-primary">
					...
					<div class="col-md-6 offset-md-2">
						...
						<form class="form-horizontal" action="<?=base_url('item/tambah');?>" method="post">
							<div class="card-body">
								<div class="form-group row">
									<label class="col-sm-4 col-form-label" for="barcode">Barcode</label>
									<div class="col-sm-8">
										<input type="text" class="form-control <?=form_error('barcode') ? 'is-invalid' : null;?>" name="barcode" id="barcode" readonly value="<?=$barcode;?>">
								...
								<div class="form-group row">
									...
									<div class="col-sm-8">
										<input type="text" class="form-control <?=form_error('nama_item') ? 'is-invalid' : null;?>" name="nama_item" id="nama_item" value="<?=$this->form_validation->set_value('nama_item');?>">
								...
								<div class="form-group row">
									...
									<div class="col-sm-8">
										<input type="text" class="form-control <?=form_error('harga') ? 'is-invalid' : null;?>" name="harga" id="harga" value="<?=$this->form_validation->set_value('harga');?>">
